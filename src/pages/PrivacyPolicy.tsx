    ...
    return (
      <>
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>1. Introduction</h2>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>2. Information We Collect</h2>
          
          <h3 className={`text-xl font-semibold mt-6 mb-3 ${subheadingClass}`}>2.1 Information You Provide</h3>
          ...
          <h3 className={`text-xl font-semibold mt-6 mb-3 ${subheadingClass}`}>2.2 Information Collected Automatically</h3>
          <ul className={`list-disc ml-6 mb-4 ${textClass}`}>
          ...
          <h3 className={`text-xl font-semibold mt-6 mb-3 ${subheadingClass}`}>2.3 Cookies and Similar Technologies</h3>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>3. How We Use Your Information</h2>
          <p className={`mb-4 ${textClass}`}>We use the collected information for various purposes:</p>
          <ul className={`list-disc ml-6 mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>4. Data Sharing and Disclosure</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>5. Data Security</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>6. Data Retention</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>7. Your Rights and Choices</h2>
          <p className={`mb-4 ${textClass}`}>You have the following rights regarding your personal information:</p>
          <ul className={`list-disc ml-6 mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>8. Children's Privacy</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>9. Third-Party Services</h2>
          <p className={`mb-4 ${textClass}`}>Our Service uses the following third-party services:</p>
          <ul className={`list-disc ml-6 mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>10. International Data Transfers</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>11. Changes to This Privacy Policy</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>12. Contact Us</h2>
          <p className={`mb-4 ${textClass}`}>
        ...
        <section className="mb-8">
          <h2 className={`text-2xl font-semibold mt-8 mb-4 ${headingClass}`}>13. Supervisory Authority</h2>
          <p className={`mb-4 ${textClass}`}>
